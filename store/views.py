    ...
    if(code):
        ...
        if(boolean_check):
            if(voucher.type == 1):
                ...
                context['discount_detail']  = voucher.code
                context['amount']  = amount
                context['discount_amount']  = decimal.Decimal(float(amount)* voucher.discount )
                context['total_amount'] = amount - decimal.Decimal(float(amount)* voucher.discount ) + shipping_amount             
