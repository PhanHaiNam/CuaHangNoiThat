...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_preprocessors.notification_list'
                ],
        },
    },
]

WSGI_APPLICATION = 'hainamshop.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'hainamshop/static')]
